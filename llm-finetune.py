...
DATASET_SLICE_TEST = "train[180:200]"  # Held-out set from Wikipedia
NUM_EPOCHS = 10
...
def load_and_prepare_data(tokenizer, dataset_slice):
    """Loads and preprocesses the dataset."""
    logging.info(f"Loading dataset slice: {dataset_slice}...")
    try:
    ...
    is_train = "train[" in dataset_slice and ":180]" in dataset_slice
